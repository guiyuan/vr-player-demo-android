...
public class AGLFont {
	 ...
	 * @see #ENGLISH 
	 */
	public AGLFont(Paint paint, boolean forceSquareTexture) {
		this(paint, ENGLISH, forceSquareTexture);
	}
	 ...
	 */
	public AGLFont(Paint paint, String alphabet, boolean forceSquareTexture) {
		...
		pack.pack(TexturePack.ALPHA_USE, forceSquareTexture);
	}
